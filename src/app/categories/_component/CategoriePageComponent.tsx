...
const CategoriePageComponent = ({ item }: { item: string }) => {
  return (
    <div className="md:h-[150px] h-[100px] flex justify-center items-center bg-gray-100 cursor-pointer">
      <div>
        <img src={item} className="md:h-[60px] md:w-[60px] h-[40px] w-[40px]" />
      </div>
      <div className="flex flex-col md:ml-8 ml-4">
        <h1 className="font-semibold md:text-xl text-sm">Jacket</h1>
