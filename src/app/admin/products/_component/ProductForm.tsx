...
//   const [images, setImages] = useState<any[]>(selectedProduct?.image || []);
...
//       if (selectedProduct === undefined && !images) {
...
//             ...productDetails.image,
//             imageUploadRes.data.image.secure_url,
//           ];
//         }
//       }
//       let res;
...
//                     {images &&
//                       images.map((image) => (
//                         <div className="p-4  relative" key={image}>
//                           <img
...
//                             onClick={() =>
//                               setImages((pre: any) =>
//                                 pre.filter((img: string) => img !== image)
//                               )
//                             }
//                           ></i>
//                         </div>
