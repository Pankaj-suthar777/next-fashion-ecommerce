...
const BrandRow = () => {
  return (
    <div className="flex pt-[40px] justify-center lg:gap-16 gap-12 sm:pb-[120px] pb-[60px] flex-wrap">
      <img
        src="https://bcassetcdn.com/public/blog/wp-content/uploads/2023/02/17202933/Adidas-Logo-1991-1024x576.jpg"
        className="lg:h-32 h-16"
      />
      <img
